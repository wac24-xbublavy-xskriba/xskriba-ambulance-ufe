...
describe('xskriba-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<xskriba-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
      components: [XskribaAmbulanceWlEditor],
      html: `<xskriba-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xskriba-ambulance-wl-editor>`
    })
